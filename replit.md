...
## Recent Changes
- 2026-03-14: Remaining Cargo Space persists TotalCapacity and CargoReserved from CarrierStats; remaining computed live as TotalCapacity - CargoReserved - sum(carrier_cargo); survives restarts
